...
public class CreateShortcut extends LauncherActivity {
    ...
    protected Intent getTargetIntent() {
        ...
        targetIntent.addCategory("com.sourcery.magiccontrol.SHORTCUT");
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        shortcutIntent.setClass(getApplicationContext(), MagicControlActivity.class);
        shortcutIntent.setAction("com.sourcery.magiccontrol.START_NEW_FRAGMENT");
    ...
    private int getProperShortcutIcon(String className) {
        ...
        if (c.equals("LEDControl"))
            ...
            return R.drawable.ic_ics_control_weather;
        else
